    ...
    <div className="space-y-4">      
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <FourSidedMeasurementsField
          ...
          onChange={(v) => onChange('Window_Four_Sided_Measurements', v)}
          onBlur={onBlur}
          onFocus={onFocus}
        />
        <br/>
        ...
        <ConfigSplitsField
          value={value.Window_Config_Splits || createEmptyConfigSplits()}
          editable={editable}
          label="Split Configuration"
          totalWidthIn={Math.min(
            value.Window_Four_Sided_Measurements?.top || 0,
            value.Window_Four_Sided_Measurements?.bottom || 0
          )}
          totalHeightIn={Math.min(
            value.Window_Four_Sided_Measurements?.left || 0,
            value.Window_Four_Sided_Measurements?.right || 0
          )}
          onChange={(v) => onChange('Window_Config_Splits', v)}
          onBlur={onBlur}
          onFocus={onFocus}
        />
