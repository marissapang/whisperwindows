...
export interface WindowObject {
	...
	// calculated_horizontal_subsections: HorizontalSplit[];
...
export function calculateAndUpdateWindow(window: WindowObject): WindowObject {
	try {
		...
		let calculatedHorizontalSubsections: HorizontalSplit[] = [];
...
const windowMeta = {
	...
	Window_Four_Sided_Measurements: {
		'label': "Window Interior Dimensions",
	},
	Window_Vertical_Splits: {
		'label': "Window Vertical Splits"
	},
	Window_Subsection_Horizontal_Splits: {
		'label': "Window Subsection  Horizontal Splits"
	},
